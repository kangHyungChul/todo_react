...
// 출발조회 보내기 타입
export interface FlightDepartureType {
    pageNo?: string;
    numOfRows?: string;
...
// 출발조회 받을때 items 타입
export interface FlightDepartureItemType {
...
// 출발조회 받을때 전체타입
export interface FlightDepartureResponseType {
    numOfRows: number;
    pageNo: number;
    totalCount: number; 
    searchDate: string;
...
// 출발조회 받을때 파라미터 타입
export interface FlightDepartureSearchParamsType {
    searchDate?: string;
    searchFrom?: string;
    searchTo?: string;
    pageNo?: string;
